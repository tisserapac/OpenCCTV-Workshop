...
private:
	ImageQueue<api::Image_t>* _pResultsOutputQueue;
	opencctv::mq::Sender* _pSender;
	opencctv::util::serialization::Serializable* _pSerializer;
public:
	ConsumerThread(ImageQueue<api::Image_t>* pResultsOutputQueue, opencctv::mq::Sender* pSender, opencctv::util::serialization::Serializable* pSerializer);
	void operator()();
};
